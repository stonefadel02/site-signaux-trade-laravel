 <div class="bg-white w-full rounded-lg p-4">
     <div class="flex items-center   justify-between mb-4">
         <div class="">
             <h6 class="text-lg font-semibold mb-0">Mes types de marché</h6>
             <p class="mb-2 text-sm text-gray-700">Liste des types de marché</p>
         </div>
         <div class="">
             <a href="{{ route('type-marches.create') }}"
                 class="inline-flex items-center px-3 py-1 bg-slate-700 text-white rounded-lg shadow hover:bg-blue-700 transition">
                 <i class="ti ti-plus mr-2"></i> Nouveau type de marché
             </a>
         </div>
     </div>
         ...
         <div class="overflow-x-auto rounded-lg shadow-none border">
             <table class="min-w-full bg-white divide-y divide-gray-200">
                 ...
                 <tbody class="divide-y divide-gray-100">
                     @forelse($typeMarches as $typeMarch)
                         <tr class="hover:bg-gray-50">

                             <td class="px-4 py-3 text-sm text-gray-700">{{ $typeMarch->Nom }}</td>
                             <td class="px-4 py-3 text-sm text-gray-700">{{ $typeMarch->Description ?? '-' }}</td>
                                 ...
                                 <div x-data="{ open: false }" class="relative inline-block text-left">
                                     ...
                                     <div x-show="open" @click.away="open = false"
                                         ...
                                         <div class="py-1" role="none">
                                             ...
                                             <form action="{{ route('type-marches.destroy', $typeMarch) }}"
