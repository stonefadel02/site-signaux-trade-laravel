...
@php
    $translationItems = __('welcome.clarification.items');
    // Map translation keys to icons in consistent order
    $signalFeatures = [
        ['name' => $translationItems['pair'], 'icon_src' => 'i1.png'],
        ['name' => $translationItems['direction'], 'icon_src' => 'i2.png'],
        ['name' => $translationItems['timeframe'], 'icon_src' => 'i3.png'],
        ['name' => $translationItems['stoploss'], 'icon_src' => 'i4.png'],
        ['name' => $translationItems['success'], 'icon_src' => 'i5.png'],
    ];
@endphp
        ...
        <div class="rounded-3xl bg-gradient-to-br from-[#1E2028] to-[#022E8F] p-8 sm:p-10 lg:p-16">
            <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
                ...
                <div class="flex justify-center">
                    <img src="{{ asset('smartphone.png') }}" alt="Signaux de trading sur un téléphone"
                ...
                <div class="sm:mx-10 text-center lg:text-left">
                    <h2 class="text-3xl font-bold tracking-tight text-white sm:text-[40px]">
                        {{ __('welcome.clarification.title') }}
                    </h2>
                    <p class="mx-2 mt-4 text-lg leading-8 text-gray-300">
                        {{ __('welcome.clarification.paragraph') }}
                    </p>
                        ...
                        @foreach ($signalFeatures as $feature)
                            <div class="flex flex-col items-center gap-4 text-center">
                                <div class="flex h-24 w-24 items-center justify-center rounded-full bg-white">
                                    <img src="{{ asset($feature['icon_src']) }}" alt="{{ $feature['name'] }}">
                                </div>
