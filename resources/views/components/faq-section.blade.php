...
$faqs = [
    ...
    [
        ...
        'answer' => 'Nous nous démarquons par la transparence, la flexibilité et nos signaux fournis manuellement par des experts, contrairement aux systèmes automatisés. Cela garantit une qualité et une fiabilité constantes.',
    ],
    // Ajoutez les autres questions/réponses ici...
    [
        'question' => 'Quels sont les signaux de trading ?',
        'answer' => "Ce sont des recommandations d'achat ou de vente basées sur des analyses techniques et fondamentales, conçues pour aider les traders à prendre des décisions rapides et informées sur différents marchés (Forex, crypto, etc.).",
    ],
     [
        'question' => 'Quels sont les signaux de trading ?',
        'answer' => "Ce sont des recommandations d'achat ou de vente basées sur des analyses techniques et fondamentales, conçues pour aider les traders à prendre des décisions rapides et informées sur différents marchés (Forex, crypto, etc.).",
            ...
            <div class="mx-auto mt-12 w-full max-w-5xl">
                <div class="grid grid-cols-1 gap-x-8 gap-y-4 lg:grid-cols-2 lg:items-start">
                    @foreach ($faqs as $index => $faq)
                        <x-animated-div
                            :delay="$index * 100"
                            class="w-full border-b border-white/5 pb-4"
                        >
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <i
                                        class="fa-solid fa-chevron-up h-5 w-5 text-current transition-transform"
