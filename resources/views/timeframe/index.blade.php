 <div class="bg-white w-full rounded-lg p-4">
     <div class="flex items-center   justify-between mb-4">
         <div class="">
             <h6 class="text-lg font-semibold mb-0">Mes timeframes</h6>
             <p class="mb-2 text-sm text-gray-700">Liste des timeframes</p>
         </div>
         <div class="">
             <a href="{{ route('timeframes.create') }}"
                 class="inline-flex items-center px-3 py-1 bg-slate-700 text-white rounded-lg shadow hover:bg-blue-700 transition">
                 <i class="ti ti-plus mr-2"></i> Nouveau timeframe
             </a>
         </div>
     </div>
                 ...
                 <tbody class="divide-y divide-gray-100">
                     @forelse($timeframes as $timeframe)
                         <tr class="hover:bg-gray-50">
                             <td class="px-4 py-3 text-sm text-gray-700">{{ $timeframe->Nom }}</td>
                             <td class="px-4 py-3 text-sm text-gray-700">{{ $timeframe->Description }}</td>
