        ...
        <div>
    <label for="plan_id" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Plan') }} <span class="text-red-500">*</span></label>
    <select name="plan_id" 
        id="plan_id"
...
<div>
    <label for="code" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Code d\'accès') }} <span class="text-red-500">*</span></label>
    <div class="flex gap-2">
        <input type="text" 
            ...
            value="{{ old('Code', $accessCode?->Code ?? $generatedCode ?? '') }}" 
            placeholder="Code de 10 caractères"
            maxlength="10"
            required>
        <button type="button" 
    ...
    @error('Code')
        <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
    @enderror
    <p class="mt-1 text-xs text-gray-500">Code de 10 caractères (lettres et chiffres). Un code a été généré automatiquement mais vous pouvez le modifier.</p>
</div>

<div>
    <label for="duree_en_jours" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Durée en jours') }} <span class="text-red-500">*</span></label>
    <input type="number" 
        name="DureeEnJours" 
        id="duree_en_jours"
        ...
        value="{{ old('DureeEnJours', $accessCode?->DureeEnJours) }}" 
...
<div>
    <label for="compteur_max" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Nombre maximum d\'utilisations') }} <span class="text-red-500">*</span></label>
    <input type="number" 
        name="CompteurMax" 
        id="compteur_max"
        ...
        value="{{ old('CompteurMax', $accessCode?->CompteurMax) }}" 
...
<div>
    <label for="expire_le" class="block text-sm font-medium text-gray-700 mb-1">{{ __('Date d\'expiration') }} <span class="text-red-500">*</span></label>
    <input type="date" 
        name="ExpireLe" 
        id="expire_le"
