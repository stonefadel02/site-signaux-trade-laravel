...
<nav class="space-y-2 flex-1 flex flex-col">
    <a href="{{ route('dashboard') }}"
        ...
        <i class="ti ti-layout-dashboard me-2"></i> {{ __('navigation.dashboard') }}
    </a>
    <a href="{{ route('signaux') }}"
        class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
        <i class="ti ti-activity me-2"></i> {{ __('navigation.signals') }}
    </a>
    <a href="{{ route('mon-abonnement') }}"
        class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
        <i class="ti ti-wallet me-2"></i>{{ __('navigation.my_subscription') }}
    </a>
    @role('Super-admin')
        <div x-data="{ open: false }" class="relative">
            <button @click="open = !open"
                ...
                <i class="ti ti-shield me-2"></i> {{ __('navigation.administration') }}
            ...
            <div x-show="open" @click.away="open = false" class="mt-1 space-y-1 pl-2">
                <a href="{{ route('users.index') }}"
                    class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
                    <i class="ti ti-users me-2"></i> {{ __('navigation.users') }}
                </a>

                <a href="{{ route('plans.index') }}"
                    class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
                    <i class="ti ti-calendar-clock me-2"></i> {{ __('navigation.plans') }}
                </a>

                <a href="{{ route('admin.souscriptions.index') }}"
                    class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
                    <i class="ti ti-wallet me-2"></i> {{ __('navigation.subscriptions') }}
                </a>
                <a href="{{ route('parametrage-signaux') }}"
                    class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
                    <i class="ti ti-calendar-clock me-2"></i> {{ __('navigation.signal_settings') }}
                </a>
                <a href="{{ route('access-codes.index') }}"
                    class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
                    <i class="ti ti-activity me-2"></i> {{ __('navigation.access_codes') }}
                </a>
    ...
    <a href="{{ route('profile.edit') }}"
        class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
        <i class="ti ti-user me-2"></i> {{ __('navigation.account_settings') }}
    </a>
    <a href="support"
        class="flex items-center px-4 py-2 rounded bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium">
        <i class="ti ti-headset me-2"></i> {{ __('navigation.support') }}
    </a>
</nav>
