...
@section('content')
    <div class="container-fullwidth">
        ...
        <div class="container"
            style="margin-top: 40px; width: 100%; max-width: none; padding: 40px; box-sizing: border-box;">
                ...
                @forelse ($paiements as $paiement)
                    <div class="payment-item">
                        ...
                        <div class="payment-details">
                            ...
                            <p class="mb-0 font-weight-bold">{{ number_format($paiement->Montant, 4) }}
                                {{ $paiement->Devise }}</p>
                        </div>

                        {{-- Statut avec icône outline --}}
                        @if ($paiement->Status === 'COMPLETED')
                            <i class="far fa-check-circle text-success" style="font-size: 28px;"
                                title="Paiement complété"></i>
                        ...
                        @else
                            <i class="far fa-question-circle text-secondary" style="font-size: 28px;"
                                title="Statut inconnu"></i>
                        @endif
                        ...
                        <div class="relative ml-3" x-data="{ open: false }" @keydown.escape="open = false"
                            ...
                            <ul x-show="open" x-transition
                                ...
                                role="menu" aria-labelledby="dropdownMenuButton{{ $paiement->id }}"
                                style="display:none;">
                                <li>
                                    <a href="{{ route('payments.download', ['id' => $paiement->id, 'format' => 'a4']) }}"
                                        target="_blank"
                                ...
                                <li>
                                    <a href="{{ route('payments.download', ['id' => $paiement->id, 'format' => 'a6']) }}"
                                        target="_blank"
                                        class="block px-4 py-2 text-gray-700 hover:bg-blue-500 hover:text-black cursor-pointer"
                                        role="menuitem">
